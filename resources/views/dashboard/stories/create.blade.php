...
<div
    ...
    "
>
    <h1 class="h2">Create New Stories</h1>
</div>

<div class="col-lg-8">
    <form
        method="post"
        action="/dashboard/stories"
        class="mb-5"
    ...
    >
        ...
        <div class="mb-3">
            ...
            <select
                class="form-select @error('places_id') is-invalid @enderror"
                name="places_id"
                id="places"
            >
        ...
        <button type="submit" class="btn btn-primary d-block mx-auto">
            <span data-feather="plus-circle"></span> Create Story
        </button>
    </form>
</div>
